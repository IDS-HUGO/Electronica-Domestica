package com.electronica.finalizado.models;
...
public class RegistroFinalizado {
    ...
    public String getRegistroTarjetaId() {
        return registroTarjetaId;
    }

    public void setRegistroTarjetaId(String registroTarjetaId) {
        this.registroTarjetaId = registroTarjetaId;
    }
    ...
    public String getProblemaCambiado() {
        return problemaCambiado;
    }

    public void setProblemaCambiado(String problemaCambiado) {
        this.problemaCambiado = problemaCambiado;
    }
